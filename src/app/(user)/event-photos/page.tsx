...
const Page = () => {
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-pink-50">
        <div className="bg-gradient-to-r from-blue-400 to-pink-400 p-4 flex items-center space-x-4 sticky top-0 z-10 shadow-md">
            <Link href={'/home'}
                // onC lick={() => setCurrentScreen("calendar")}
          ...
          >
            {photo.startsWith("data:image/") ? (
              ...
              <span className="text-6xl">{photo}</span>
                ...
                <div className="bg-gradient-to-br from-blue-100 to-pink-100 rounded-2xl shadow-lg flex items-center justify-center aspect-square border-2 border-dashed border-blue-300 cursor-pointer hover:bg-gradient-to-br hover:from-blue-200 hover:to-pink-200 transition-all">
